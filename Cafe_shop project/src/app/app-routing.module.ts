...
const routes: Routes = [
  ...
  //   path: 'payment',
  //   loadChildren: () =>
  //     import('./modules/payment-module/payment-module.module').then(
  //       (m) => m.PaymentModuleModule
  //     ),
  // },
  // {
  //   path: 'product',
  //   loadChildren: () =>
  //     import('./modules/product-module/product-module.module').then(
  ...
  //   path: 'rider',
  //   loadChildren: () =>
  //     import('./modules/rider-module/rider-module.module').then(
  //       (m) => m.RiderModuleModule
  //     ),
  // },
  // {
  //   path: 'user',
