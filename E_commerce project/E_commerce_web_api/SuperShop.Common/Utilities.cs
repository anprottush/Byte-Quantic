...
namespace SuperShop.Common
{
    ...
    {
        public static string ECategoryImagePath = "/Images/" + ImageFolderName.CategoryPictures.ToString() + "/";
        public static string EBrandImagePath = "/Images/" + ImageFolderName.BrandPictures.ToString() + "/";
        public static string ECustomerProfileImagePath = "/Images/" + ImageFolderName.CustomerProfilePictures.ToString() + "/";
        public static string EProductImagePath = "/Images/" + ImageFolderName.ProductPictures.ToString() + "/";
        public static string ERiderImagePath = "/Images/" + ImageFolderName.RiderPictures.ToString() + "/";
        public static string EProviderImagePath = "/Images/" + ImageFolderName.ProviderPictures.ToString() + "/";
        public static string EReturnImagePath = "/Images/" + ImageFolderName.ReturnPictures.ToString() + "/";
